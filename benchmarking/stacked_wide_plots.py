...
#%%
def setup_plot(ylabel, ax):
    ax.set(xscale="log", yscale="log")
    ax.set_title(None)
    ax.set_xlabel("Average Distance")
    ax.set_ylabel(ylabel)
    ax.set_ylim(top=1e3, bottom=1e-1)
...
plt.savefig(
    os.path.join(plot_folder, "distance_wide_stacked.png"),
    facecolor="white",
    bbox_inches="tight",
)
...
plt.savefig(
    os.path.join(plot_folder, "distance_wide_stacked_grad.png"),
    facecolor="white",
    bbox_inches="tight",
)